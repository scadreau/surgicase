...
# Last Modified: 2025-07-15 20:33:11
                ...
                if user:
                    ...
                    cursor.execute("""
                        INSERT INTO deleted_users (
                            ...
                            user_type, message_pref, states_licensed, created_at, updated_at
                    ...
                    """, (
                        ...
                        user["message_pref"], user["states_licensed"], user.get("created_at"), user.get("updated_at")
                    ))
