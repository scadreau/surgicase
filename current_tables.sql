...
-- Generated on: 2025-07-30 20:58:44
-- Database: allstars
-- MySQL Version: 8.0.39

-- Table: case_doc_type_list
CREATE TABLE `case_doc_type_list` (
  `document_type` varchar(100) DEFAULT NULL,
  `doc_prefix` varchar(25) DEFAULT NULL
...
-- Table: case_status_list
CREATE TABLE `case_status_list` (
  `case_status` smallint unsigned NOT NULL,
...
CREATE TABLE `cases` (
  ...
  `pay_category` varchar(20) DEFAULT NULL,
  `pending_payment_ts` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`case_id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `deleted_facilities` (
  ...
  `facility_addr` varchar(100) DEFAULT NULL,
...
CREATE TABLE `deleted_surgeons` (
  ...
  `surgeon_addr` varchar(100) DEFAULT NULL,
  `surgeon_city` varchar(50) DEFAULT NULL,
  `surgeon_state` varchar(50) DEFAULT NULL,
  `surgeon_zip` varchar(20) DEFAULT NULL,
...
CREATE TABLE `deleted_users` (
  ...
  `max_case_status` int unsigned DEFAULT NULL,
  PRIMARY KEY (`user_id`),
  KEY `idx_active` (`active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `facility_list` (
  ...
  PRIMARY KEY (`facility_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1000047 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `insurance_plans` (
  ...
  `ins_provider` varchar(250) DEFAULT NULL,
  `flagged` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_ins_provider` (`ins_provider`)
...
CREATE TABLE `npi_data_1` (
  ...
  KEY `idx_last_first_name` (`provider_last_name`,`provider_first_name`),
  KEY `idx_first_last_name` (`provider_first_name`,`provider_last_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Table: npi_facility_list
CREATE TABLE `npi_facility_list` (
  `provider_organization_name` varchar(100) DEFAULT NULL,
  `recs` bigint NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Table: npi_search_table_log
CREATE TABLE `npi_search_table_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `execution_ts` datetime NOT NULL,
  `table_type` enum('surgeon','facility') NOT NULL,
  ...
  `error_message` text,
  PRIMARY KEY (`id`),
  KEY `idx_execution_ts` (`execution_ts`),
  KEY `idx_table_type` (`table_type`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Table: npi_update_log
CREATE TABLE `npi_update_log` (
  `execution_ts` timestamp NULL DEFAULT NULL,
  `filename_processed` varchar(250) DEFAULT NULL,
  `total_rows` bigint DEFAULT NULL,
  `total_0_rows` bigint DEFAULT NULL,
  `total_1_rows` bigint DEFAULT NULL,
  `total_2_rows` bigint DEFAULT NULL,
  `created_ts` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Table: procedure_code_buckets
CREATE TABLE `procedure_code_buckets` (
  `code_category` varchar(20) DEFAULT NULL,
  `code_bucket` varchar(50) DEFAULT NULL,
...
-- Table: procedure_codes_desc
CREATE TABLE `procedure_codes_desc` (
  `procedure_code` varchar(10) NOT NULL,
  `procedure_desc` varchar(1000) DEFAULT NULL,
  `code_category` varchar(20) DEFAULT NULL,
  `code_status` varchar(20) DEFAULT NULL
...
-- Table: procedure_codes_new_tier
CREATE TABLE `procedure_codes_new_tier` (
  `procedure_code` varchar(10) NOT NULL,
  `procedure_desc` varchar(1000) DEFAULT NULL,
  `code_category` varchar(20) DEFAULT NULL,
  `code_status` varchar(20) DEFAULT NULL,
  `code_pay_amount` decimal(10,2) DEFAULT '0.00',
  `tier` int unsigned DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=5606 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Table: search_facility
CREATE TABLE `search_facility` (
  `npi` bigint DEFAULT NULL,
...
-- Table: search_surgeon
CREATE TABLE `search_surgeon` (
  `npi` bigint DEFAULT NULL,
...
CREATE TABLE `surgeon_list` (
  ...
  PRIMARY KEY (`surgeon_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=100064 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Table: taxonomy_list
CREATE TABLE `taxonomy_list` (
  `code` varchar(10) DEFAULT NULL,
  `taxonomy_grouping` varchar(100) DEFAULT NULL,
...
-- Table: user_doc_type_list
CREATE TABLE `user_doc_type_list` (
...
CREATE TABLE `user_profile` (
  ...
  `user_npi` bigint unsigned DEFAULT NULL COMMENT 'National Provider Identification',
  `referred_by_user` varchar(100) DEFAULT NULL,
  `user_type` int unsigned DEFAULT '1' COMMENT '1 = Provider, 7 = Group Admin, 10 = Case Admin, 20 = User Admin, 100 = Global Admin, 999 = System Admin',
  `message_pref` smallint DEFAULT '0' COMMENT '0 = no messages, 1 = email, 2 = sms, 3 = both',
  `create_ts` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `last_login_dt` datetime DEFAULT NULL,
  `active` tinyint DEFAULT '1',
  ...
  `last_updated_ts` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `user_tier` int unsigned NOT NULL DEFAULT '1',
  `max_case_status` int unsigned DEFAULT '20',
  PRIMARY KEY (`user_id`),
  KEY `idx_active` (`active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `user_type_list` (
  ...
  `user_type_desc` varchar(100) DEFAULT NULL,
  `user_max_case_status` int unsigned DEFAULT NULL,
